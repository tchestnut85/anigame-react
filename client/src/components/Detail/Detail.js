          ...
          <div id="detail-info" className={`column is-two-thirds`}>
            ...
            <div className="columns">
              <p className="column subtitle is-6 has-text-right">
                <b>Released:</b> {getYear(details?.release_date)}
              </p>
